...
public class PasswordCheckerTest {
    ...
    public void passwordOfInvalidLength() {
        assertThrows(InvalidPasswordLengthException.class, () -> {
            passwordChecker.validate("Pass");
        });
    }

    @Test
    public void passwordDoesNotContainUpperCase() {
        assertThrows(LowercasePasswordException.class, () -> {
            passwordChecker.validate("password123!");
        });
    }
    ...
    public void passwordDoesNotContainSpecialChar() {
        assertThrows(SpecialCharacterNotFoundInPasswordException.class, () -> {
            passwordChecker.validate("paS5word123");
        });
    }
}
